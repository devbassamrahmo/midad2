...
const Vision = () => {
  return (
    <div className="relative w-full min-h-[480px] sm:min-h-[560px] lg:h-[700px]">
      {/* Background Image */}
      <Image
        src="/vision/Rectangle.svg"
        alt="vision"
        fill
      ...
      >
        <div>
          <h1 className="font-citadel text-[40px] sm:text-[52px] lg:text-[68px]">
            Vision
          </h1>
        ...
        <p className="font-helvetica text-[14px] sm:text-[16px] lg:text-[18px] max-w-full lg:max-w-[600px]">
          By blending smart design, sustainability, and cultural authenticity, Midad ensures every
          development leaves a lasting impact while preparing for the future.
        </p>
