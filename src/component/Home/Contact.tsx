...
const Contact = () => {
    ...
    return (
        <div className="h-auto w-full px-8 md:px-[85px] py-10 md:py-[85px] bg-[#fffdf5]">
            <h1 className="text-[26px] md:text-[32px] font-editors italic mb-10 text-[#4C231A]">
                Contact Us
            </h1>

            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 md:gap-12 max-w-[800px]">

                {/* Name */}
                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-20">
                    <label className="text-[18px] font-helvetica text-[#4C231A] w-[120px]">Name</label>
                ...
                {/* Number */}
                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-20 z-[10000]">
                    <label className="text-[18px] font-helvetica text-[#4C231A] w-[120px]">Number</label>
                    <div className="flex flex-col w-full md:w-[350px]">
                        <PhoneInput
                            country={'sa'}
                            value={phone}
                ...
                {/* Email */}
                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-20">
                    <label className="text-[18px] font-helvetica text-[#4C231A] w-[120px]">Email</label>
                    <div className="flex flex-col w-full md:w-[350px]">
                        <input
                            type="email"
                            {...register('email')}
                ...
                <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-20 relative">
                    <label className="text-[18px] font-helvetica text-[#4C231A] w-[120px] mt-2 md:mt-0 z-10">Message</label>
