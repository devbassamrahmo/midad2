  ...
  return (
    <div className="w-full sm:bg-[#f3f0eb] py-16 px-6 sm:px-8 lg:py-20 lg:px-20 xl:px-28">
      ...
      >
        ...
        <h3 className="text-[12px] sm:text-[13px] lg:text-[14px] text-[#AE9E75] sm:mb-8 lg:mb-10">
          Quick Facts / Impacts
        </h3>
      </div>

      {/* Cards */}
      <div className="grid grid-cols-1 lg:grid-cols-4 xl:gap-8 sm:border-t border-[#4C231A]">
        {data.map((item, i) => (
          <div
            key={i}
            ref={(el) => {
            ...
            <div className="flex w-full flex-row gap-4 sm:gap-5 items-stretch lg:flex-col">
              <div className="w-1/2 flex flex-col justify-between lg:w-full">
                <div className="space-y-1">
                  <div className="text-[#4C231A] font-editors italic text-[28px] sm:text-[32px] lg:text-[36px] flex items-baseline">
