...
const ContactShare = () => {
  ...
  return (
    <div className="py-12 bg-white">
      <div className="h-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:p-[70px]">
        <div>
          ...
          >
            ...
            <div className="flex flex-row items-center gap-4">
              <label className="text-[18px] font-helvetica w-[120px]">
                Name
              </label>
            ...
            {/* Number */}
            <div className="flex flex-row items-center gap-6 z-[500]">
              <label className="text-[18px] font-helvetica w-[113px]">
                Number
              </label>
              <div className="w-full md:w-[350px]">
                <PhoneInput
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-4">
              ...
              <button
                ...
                className={`mt-3 sm:mt-4 w-fit mx-auto sm:mx-0 px-12 py-3 rounded-full text-black transition-colors ${
