...
const ContactForm = () => {
  ...
  return (
    <div className="w-full py-24 md:pt-[211px] md:px-[70px]">
      <div className="w-full bg-[#000000] px-8 md:px-[60px] py-10 shadow-lg">
        <h1 className="text-[26px] md:text-[32px] font-editors italic mb-10 text-[#FFFFFF]">
          Contact Us
        </h1>

        <form className="flex flex-col gap-8 md:gap-12 max-w-[800px]" onSubmit={handleSubmit(onSubmit)}>
          {/* Name */}
          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-20">
            <label className="text-[18px] font-helvetica text-[#FFFFFF] w-[120px]">Name</label>
          ...
          {/* Number */}
          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-20 z-[500]">
            <label className="text-[18px] font-helvetica text-[#FFFFFF] w-[120px]">Number</label>
          ...
          {/* Email */}
          <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-20">
            <label className="text-[18px] font-helvetica text-[#FFFFFF] w-[120px]">Email</label>
            <div className="flex flex-col w-full md:w-[350px]">
              <input
                {...register('email')}
                type="email"
          ...
          <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-20 relative">
            <label className="text-[18px] font-helvetica text-[#FFFFFF] w-[120px] mt-2 md:mt-0 z-10">Message</label>
          ...
          <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-20">
            ...
            <button
              type="submit"
              className="w-[120px] px-6 py-3 rounded-full text-white font-helvetica bg-black transition-colors hover:bg-[#111111]"
              style={{
