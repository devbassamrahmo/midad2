...
export default function ContactInfo() {
  return (
    <section className="bg-white w-full px-8 md:px-[130px] py-10 md:pt-0 md:pb-24">
      {/* Contact Us */}
      <div>
        <h3 className="font-editors font-semibold text-[20px] md:text-[22px] italic text-[#1b1b1b] mb-4">
          Contact Us
        </h3>
      ...
      <div className="mt-12">
        ...
        <address className="not-italic font-medium text-[14px] md:text-[15px] leading-relaxed text-[#1b1b1b]">
